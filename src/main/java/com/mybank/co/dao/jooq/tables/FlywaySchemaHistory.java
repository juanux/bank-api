...
import com.mybank.co.dao.jooq.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = 352029993;
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, String> INSTALLED_ON = createField(DSL.name("installed_on"), org.jooq.impl.SQLDataType.CLOB.nullable(false).defaultValue(org.jooq.impl.DSL.field("strftime('%Y-%m-%d %H:%M:%f','now')", org.jooq.impl.SQLDataType.CLOB)), this, "");
